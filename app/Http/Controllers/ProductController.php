...
class ProductController extends Controller
{
    ...
    {
        $existing_cat=Category::where('store_id',$this->sdc->storeID())->whereNotIn('name', ['Inventory Repair', 'Non-Inventory Repair'])->get();
    ...
    {
        $existing_cat=Category::where('store_id',$this->sdc->storeID())->whereNotIn('name', ['Non-Inventory Repair'])->get();
        $tab=$product::find($id);
        //dd($tab);
