var csrftLarVe = $('meta[name="csrf-token"]').attr("content");
	...
	$(document).ready(function(){
            ...
            if(partialpayment_addPartialPayment_env == 1){
                $("#addPartialPayment").modal("show");
                    ...
                    //------------------------Ajax Customer Start-------------------------//
                     $.ajax({
                        ...
                        'global': true,
                        'dataType': 'json',
                        'url': partialpayment_partialpay_invoice_ajax,
                        ...
                        'success': function (data) 
                        {
                            ...
                            $.each(data,function(index,row){
                                ...
                                {
                                    if(partialpayment_partial_invoice_invoiceID !=null){
                                        if(row.invoice_id==partialpayment_partial_invoice_invoiceID)
                                        {
            ...
            $(".manualPaypalPayment").click(function(){
                    ...
                    if($.trim(today_paid)>0)
                    {
                        ...
                        window.location.href=partialpayment_partial_pay_paypal+"/"+invoice_id+"/"+today_payment_method_id+"/"+today_paid;
            ...
            //console.log("WOrking");
                    ...
                    $(".hidestripemsg").html(loadingOrProcessing("CardPointe payment please wait...."));
                     ...
                     $.ajax({
                        ...
                        'global': false,
                        'dataType': 'json',
                        'url': partialpayment_cardpointe_partial_payment,
                        'data': {
                ...
                $(".cardpointe_bolt_payment_manual").click(function(){
                    ...
                    //$(".payModal-message-area").html("<div class='col-md-12'>"+loadingOrProcessing("Please wait, checking bolt device.")+"<div>");
                        ...
                        $.ajax({
                            ...
                            'global': false,
                            'dataType': 'json',
                            'url': partialpayment_bolt_pingDevice,
                            'success': function (data) {
                                        ...
                                        'success': function (data) {
                                            ...
                                            else
                                            {
                                                ...
                                                $.ajax({
                                                    ...
                                                    'global': false,
                                                    'dataType': 'json',
                                                    'url': partialpayment_bolt_partial_capture,
                                                    'data': {
                                                        'amountToPay':parseNewPayment,
                ...
                $(".manualstripe_card_payment").click(function(){
                    ...
                    if($.trim(today_paid)>0)
                    {
                       ...
                       //$(".ManualAutorizeCapture").show();
                        ...
                        $("#payment-form-stripe").attr("action",partialpayment_stripepartialURL);
            ...
            $(".card-pay-authorizenetmanual").click(function(){
                ...
                $(".ManualAutorizeCapture").hide();
                 ...
                 $.ajax({
                    ...
                    'global': false,
                    'dataType': 'json',
                    'url': partialpayment_authorize_net_capture_pos_partial_payment,
                    'data': {
                        'invoice_id':invoice_id,
                        'cardNumber':cardNumber,
                        'cardHName':cardHName,
