<div class="modal fade text-xs-left" id="stripePartialCustomerCard" tabindex="-3" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
        ...
        <div class="col-md-12">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('stripe.partial') }}" method="post" class="partialStripePay"
...
$(function() {
    ...
    var $formStripePartial         = $(".partialStripePay");
  $('form.partialStripePay').bind('submit', function(e) {
    var $formStripePartial         = $(".partialStripePay"),
        inputSelector = ['input[type=email]', 'input[type=password]',
                         'input[type=text]', 'input[type=file]',
                         'textarea'].join(', '),
        $inputs       = $formStripePartial.find('.required').find(inputSelector),
        $errorMessage = $formStripePartial.find('div.error'),
        valid         = true;
    ...
    if (!$formStripePartial.data('cc-on-file')) {
      e.preventDefault();
      Stripe.setPublishableKey($formStripePartial.data('stripe-publishable-key'));
      Stripe.createToken({
