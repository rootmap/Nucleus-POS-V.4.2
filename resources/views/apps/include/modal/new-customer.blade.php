...
<div class="modal fade text-xs-left" id="NewCustomerDash" tabindex="-3" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <h3 class="modal-title" id="myModalLabel35"><i class="icon-user-plus"></i> Add new customer</h3>
                  </div>
                  <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" value=""  name="new_customer_address" placeholder="Address">
                            </div>
                        </div>
                        <div class="form-group row">
