      ...
      <form>
        <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            @if(isset($authorizeNettender))
              @if(!empty($authorizeNettender))
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 button button1 authorizenet btn-group">
                  <a  data-id="{{$authorizeNettender[0]->id}}" type="button" class="btn btn-green btn-lighten-1 btn-responsive  btn-block  margin-all-bottom-button manualcardPayment" >
            ...
            @if(!empty($stripe))
              <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 button button1 authorizenet btn-group">
                    <a  data-id="26" type="button" class="btn btn-green btn-block btn-lighten-1 btn-responsive  btn-block  margin-all-bottom-button manualstripe_card_payment" >
                        Stripe
                    </a> 
              </div>
            @endif
            ...
            @if(!empty($cardpointe))
              @if($cardpointe->module_status==1)
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 button button1 authorizenet btn-group">
                      <a  data-id="26" type="button" class="btn btn-green btn-block btn-lighten-1 btn-responsive  btn-block  margin-all-bottom-button cardpointe_card_payment_manual" >
                          CardPointe
                      </a> 
                </div>
              @endif
              ...
              @if($cardpointe->bolt_status==1)
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 button button1 authorizenet btn-group">
                      <a  data-id="26" type="button" class="btn btn-green btn-block btn-lighten-1 btn-responsive  btn-block  margin-all-bottom-button cardpointe_bolt_payment_manual" >
                          Bolt
                      </a> 
                </div>
              @endif
            ...
            @if(isset($payPaltender))
              @if(!empty($payPaltender))
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 button button1 authorizenet btn-group">
                  <a  data-id="{{$payPaltender[0]->id}}" type="button" class="btn btn-green btn-lighten-2 btn-responsive margin-all-bottom-button  btn-block  manualPaypalPayment" >
                    {{$payPaltender[0]->name}}
                  </a>
                </div>
              @endif
            ...
            @if(isset($square))
              @if(!empty($square))
              <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 button button1 authorizenet btn-group">
                    <a  data-id="SquareupPayment" type="button" class="btn btn-green btn-block btn-lighten-2 btn-responsive margin-all-bottom-button SquareupPartalPayment" >
                        Square
                    </a> 
              </div>
              @endif
            ...
            @if(isset($tender))
              @foreach($tender as $ten)
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 button button1">
                  <button  data-id="{{$ten->id}}" type="button" class="btn btn-green btn-responsive margin-all-bottom-button  btn-block  manualMakePayment" >
                  {{$ten->name}}
                  </button>
                </div>
              @endforeach
