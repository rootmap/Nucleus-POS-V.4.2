          ...
          <div class="row">
            <div class="col-sm-12">
              <fieldset>
                ...
                <label class="custom-control custom-checkbox display-inline">
                  <input type="checkbox" id="nuc-search-repair" class="custom-control-input"><span class="custom-control-indicator"></span><span class="custom-control-description m-0">Inventory Repair</span>
                </label>
                <label class="custom-control custom-checkbox display-inline">
                  <input type="checkbox" id="nuc-search-ticket" class="custom-control-input"><span class="custom-control-indicator"></span><span class="custom-control-description m-0">Non - Inventory Repair</span>
                </label>
                <label class="custom-control custom-checkbox display-inline">
