										...
										<div class="form-group">
				                            ...
				                            <input type="text" 
												@if(isset($edit))
													value="{{$edit->name}}" 
												@endif 
												 id="eventRegInput1"  readonly="" class="form-control border-primary" placeholder="Full name" name="name">
				                        </div>
				                        <div class="form-group">
			                            	<label for="projectinput1">Email </label>
				                            	 
												@if(isset($edit))
												<input type="text"  readonly="" id="eventRegInput2" class="form-control border-primary" placeholder="Email Address" name="email" readonly="" value="{{$edit->email}}">
												@endif 
				                        ...
				                        <div class="form-group">
			                            	<label for="projectinput1">Phone </label>
												...
												@if(isset($edit))
													value="{{$edit->phone}}" 
												@endif 
												 id="eventRegInput4"  readonly="" class="form-control border-primary" placeholder="Phone Number" name="phone">
				                        </div>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
			                            	<label for="projectinput1">User ID </label>
				                            	<input type="text" @if(isset($edit))
													value="{{$edit->id}}" 
												@endif  readonly=""  class="form-control border-primary" placeholder="Store ID">
				                        </div>
										<div class="form-group">
				                        ...
				                        <div class="form-group">
			                            	<label for="projectinput1">Store Name </label>
												...
												@endif  readonly="" class="form-control border-primary" placeholder="Store Name">
				                        </div>
                                        ...
                                        <div class="form-group">
			                            	<label for="projectinput1">Address </label>
												...
												@if(isset($edit))
													value="{{$edit->address}}" 
												@endif 
												 id="eventRegInput5"  readonly="" class="form-control border-primary" placeholder="Address" name="address">
				                        </div>
