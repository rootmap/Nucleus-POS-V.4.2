							...
							<div class="form-body">
		                        ...
		                        <div class="form-group col-md-6">
		                            ...
		                            <input type="text" 
										@if(isset($edit))
											value="{{$edit->name}}" 
										@endif 
										 id="eventRegInput1"  readonly="readonly" class="form-control border-green" placeholder="Full name" name="name">
		                        </div>
								<div class="form-group col-md-6">
		                        ...
		                        <div class="form-group col-md-6">
	                            	<label for="projectinput1">Contact Email </label>
										...
										<input type="text" id="eventRegInput1" class="form-control border-green" placeholder="Email Address"   readonly="readonly" name="email" @if(isset($edit)) value="{{$edit->email}}" @endif>
		                        ...
		                        <div class="form-group col-md-6">
	                            	<label for="projectinput1">Phone </label>
										...
										@if(isset($edit))
											value="{{$edit->phone}}" 
										@endif 
										 id="eventRegInput1" readonly="readonly" class="form-control border-green" placeholder="Phone Number" name="phone">
		                        </div>
		                        <div class="form-group col-md-12">
	                            	<label for="projectinput1">Address </label>
										...
										@if(isset($edit))
											value="{{$edit->address}}" 
										@endif 
										 id="eventRegInput1"  readonly="readonly" class="form-control border-green" placeholder="Address" name="address">
		                        </div>
