							...
							<div class="form-body">
                                    ...
                                    @endif
                                     mb-2 proNameArea">
                                        ...
                                        @if(isset($edit))
                                            value="{{$dataRow->name}}" 
                                        @endif 
                                        id="eventRegInput1" class="form-control border-green tpname" placeholder="Product Name" name="name">
                                    </div>
								...
								<div class="row">
									...
									<div class="form-group col-md-4 mb-2">
                                        ...
                                        value="{{$dataRow->price}}" 
                                        @endif 
                                        type="text"  class="form-control border-green tpprice" placeholder="Price Per Item" value="0" name="price">
									</div>
                                    ...
                                    <div class="col-md-5 offset-md-3 product_with_image">
                                        <a  href="#" class="card mb-1" style="border-bottom-right-radius:3px; border-bottom-left-radius: 3px;">
                                            ...
                                            @if(isset($edit))
                                                ...
                                                @else
                                                    src="{{ url('images/product-avater.jpg') }}" 
                                                @endif
                                            ...
                                            <div class="card-body collapse in">
                                                ...
                                                <div class="p-1 card-header" style="padding: 0.7rem !important;">
                                                    <p style="margin-bottom: 0px !important; min-height: 40px; color: #fff;" class="text-xs-left green product_name_place" style="color: #fff;">
                                                        @if(isset($edit))
                                            ...
                                            <div class="text-xs-right green" style="line-height: 30px; padding-right: 10px; font-weight: bolder; height: 30px; color: #545a63;">$<span class="product_price_place">
                                                @if(isset($edit))
