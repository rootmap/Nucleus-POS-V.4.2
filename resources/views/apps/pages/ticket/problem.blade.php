...
@section('title','Non-Inventory Reapir Problem')
@section('content')
...
?>  
		...
		<div class="row">
		<div class="col-md-6" @if($userguideInit==1) data-step="1" data-intro="you can added/modify new non-inventory reapir problem." @endif>
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-card-center">
						@if(isset($edit))
						<i class="icon-user-plus"></i> Edit Non-Inventory Reapir Problem
						@else
						<i class="icon-user-plus"></i> Add New Non-Inventory Reapir Problem
						@endif
					</h4>
		...
		<div class="col-md-6" @if($userguideInit==1) data-step="2" data-intro="You are seeing all the ticket problem list in this table." @endif>
				<div class="card">
				<div class="card-header">
					<h4 class="card-title"><i class="icon-users2"></i> Non-Inventory Reapir Problem List</h4>
					<a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
	        		<div class="heading-elements">
						<ul class="list-inline mb-0">
							<li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
