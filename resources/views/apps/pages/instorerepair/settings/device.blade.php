...
@section('title','Edit Device Info')
@section('content')
			...
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-card-center">
						<i class="icon-cog3"></i> Edit Inventory Reapir Device Info 
					</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
						<form class="form" action="{{url('settings/instore/device/edit/'.$tab->id)}}"  method="post">
							<div class="form-body">
								{{ csrf_field() }}
								<div class="form-group step1">
									<label for="userinput1">Device <span class="text-danger">*</span></label>
									<input type="text" value="{{$tab->name}}"  class="form-control border-green" placeholder="Enter Device Name" name="device_name">
								</div>
