...
@section('title','Create New '.$asset=='Ticket'?'Non-Inventory Repair':'Inventory Repair'.' Asset ')
@section('content')
...
?>
	<div class="row">
				...
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-card-center">
						...
						@else
							New 
						@endif 
						{{$asset=='Ticket'?'Non-Inventory Repair':'Inventory Repair'}} Asset 
					</h4>
		...
		<div class="col-md-8 col-xs-8 col-xl-8" @if($userguideInit==1) data-step="4" data-intro="You are seeing your all assets list." @endif>
			<div class="card">
				<div class="card-header">
					<h4 class="card-title"><i class="icon-table"></i> {{$asset=='Ticket'?'Non-Inventory Repair':'Inventory Repair'}} Assets</h4>
					<a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
	        		<div class="heading-elements">
						<ul class="list-inline mb-0">
	                        <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
