...
@section('title','Inventory Reapir Price List')
@section('content')
...
?>
	...
	<!-- Both borders end-->
<div class="row">
	<div class="col-xs-12" @if($userguideInit==1) data-step="1" data-intro="You are seeing your all inventory reapir price list." @endif>
		<div class="card">
			<div class="card-header">
				<h4 class="card-title"><i class="icon-users2"></i> Inventory Reapir Price List</h4>
