...
<section id="form-action-layouts">
	...
	?>
	<div class="row">
		<div class="col-md-12" @if($userguideInit==1) data-step="1" data-intro="You can see Ticket by date wise or invoice or Customer and generate excel or PDF." @endif>
			<div class="card">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('ticket/excel/report')}}" class="btn btn-green btn-darken-2 mr-1 change-action" @if($userguideInit==1) data-step="3" data-intro="If you click this button then it will generate excel file." @endif>
												<i class="icon-file-excel-o"></i> Generate Excel
											</a>
											<a href="javascript:void(0);" data-url="{{url('ticket/pdf/report')}}" class="btn btn-green btn-darken-3 mr-1 change-action" @if($userguideInit==1) data-step="4" data-intro="If you click this button then it will generate pdf file." @endif>
												<i class="icon-file-pdf-o"></i> Generate PDF
											</a>
											<a href="{{url('ticket/report')}}" style="margin-left: 5px;" class="btn btn-green btn-darken-4" @if($userguideInit==1) data-step="5" data-intro="if you want clear all information then click the reset button." @endif>
					...
					<table class="table table-striped table-bordered" id="report_table">
						<thead>
							<tr>
								...
								<th width="600">Ticket Subject</th>
								<th>Our Cost</th>
								<th>Retail Price</th>
								<th>Status</th>
								<th>Invoice ID</th>
   ...
   <script>
    ...
    $(document).ready(function(e){
        ...
        $('#report_table').dataTable({
            ...
            "ajax":{
                url :"{{url('ticket/data/report/json')}}",
                headers: {
