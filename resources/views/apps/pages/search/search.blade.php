                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            value="{{$search}}"
                                            @endif
                                            type="text" id="inpage_search_nuc" class="form-control border-primary" placeholder="Search Anything" name="inpage_search_nuc">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <h4>&nbsp;</h4>
                                        <div class="input-group">
                                            <button type="button" id="inpageSearchbtn" class="btn btn-green btn-darken-1 mr-1">
                                    ...
                                    <div class="col-sm-12" style="padding-top: 20px;">
                                        <fieldset>
                                            ...
                                            <label class="custom-control custom-checkbox display-inline">
                                            <input type="checkbox" id="inpage_nuc-search-repair" class="custom-control-input"><span class="custom-control-indicator"></span><span class="custom-control-description m-0">Inventory Repair</span>
                                            </label>
                                            <label class="custom-control custom-checkbox display-inline">
                                            <input type="checkbox" id="inpage_nuc-search-ticket" class="custom-control-input"><span class="custom-control-indicator"></span><span class="custom-control-description m-0">Non - Inventory Repair</span>
                                            </label>
                                            <label class="custom-control custom-checkbox display-inline">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-xs-center">
                        @if(isset($search))
                            <i class="icon-search"></i> Searching For : [<span class="text-success">{{$search}}</span>] | Total Record Found : [<span id="total_search_found" class="text-success">0</span>]
                        @else
                ...
                <div class="card-body collapse in">
                    ...
                    <div class="row repair_place">
                        <div id="inventory_repair_search_result_loader" class="col-md-12"></div>
                    </div>
                    <!-- Repair Search Result Start-->
                    <div class="card repair_place">
                        <div class="card-header">
                            <h4 class="card-title"><i class="icon-medkit"></i> Inventory Repair : Found Total Record [<span id="inventory_repair_total_record">0</span>]</h4>
                        </div>
                        <div class="card-body collapse in">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="inventory_repair_table">
                                    <thead>
                                        <tr>
                                            <th>Inventory Repair-Id</th>
                                            <th>Date</th>
                                            <th>Customer</th>
                                            <th>Repair Detail</th>
                                            <th>Price</th>
                    ...
                    <!-- Repair Search Result End-->
                    <div class="row ticket_place">
                        <div id="non_inventory_repair_search_result_loader" class="col-md-12"></div>
                    </div>
                    <!-- Non Inventory Repair Search Result Start-->
                    <div class="card ticket_place">
                        <div class="card-header">
                            <h4 class="card-title"><i class="icon-database"></i> Non-Inventory Repair : Found Total Record [<span id="non_inventory_repair_total_record">0</span>]</h4>
                        </div>
                        <div class="card-body collapse in">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="non_inventory_repair_table">
                                    <thead>
                                        <tr>
                                            <th>Non-Inventory Repair-Id</th>
                                            <th>Date</th>
                                            <th>Customer</th>
                    ...
                    <!-- Non Inventory Repair Search Result End-->
...
@section('RoleWiseMenujs')
   <script>
    var viewInvoiceURL="{{secure_url('sales/invoice')}}";
        ...
        var searchInventoryRepairURL="{{secure_url('search-nuc/inventory/repair')}}";
        var searchNonInventoryRepairURL="{{secure_url('search-nuc/non-inventory/repair')}}";
    ...
    function findnInpageCOnvertParam(){
        ...
        if($('#inpage_nuc-search-repair').is(":checked")){ nuc_search_repair = 1; }

        var  nuc_search_ticket = 0;
        if($('#inpage_nuc-search-ticket').is(":checked")){ nuc_search_ticket = 1; }
        ...
        inpage_search_param['inpage_nuc_search_repair']=nuc_search_repair;
        inpage_search_param['inpage_nuc_search_ticket']=nuc_search_ticket;
    ...
    $(document).ready(function(e){
        ...
        $("#inpageSearchbtn").click(function(){
            ...
            Swal.showLoading();
                ...
                if(inpage_search_param['inpage_nuc_search_all']==0 && inpage_search_param['inpage_nuc_search_repair']==1){
                    $(".repair_place").fadeIn('slow');
                    searchInventoryRepair(inpage_search_nuc,encode_param);
                }

                if(inpage_search_param['inpage_nuc_search_all']==0 && inpage_search_param['inpage_nuc_search_ticket']==1){
                    $(".ticket_place").fadeIn('slow');
                    searchNonInventoryRepair(inpage_search_nuc,encode_param);
                }
        ...
        @if(isset($search))
            ...
            if(searchParam['nuc_search_all']==1){
                ...
                searchInventoryRepair("{{$search}}",searchParam);
                searchNonInventoryRepair("{{$search}}",searchParam);
            ...
            if(searchParam['nuc_search_all']==0 && searchParam['nuc_search_repair']==1){
                $(".repair_place").fadeIn('slow');
                searchInventoryRepair("{{$search}}",searchParam);
            }

            if(searchParam['nuc_search_all']==0 && searchParam['nuc_search_ticket']==1){
                $(".ticket_place").fadeIn('slow');
                searchNonInventoryRepair("{{$search}}",searchParam);
            }
