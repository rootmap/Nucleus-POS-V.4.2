						...
						class="form form-horizontal striped-labels">
	                			...
	                			<div class="form-group row last">
	                        		...
	                        		<div class="col-md-7">
										<div class="form-group">
											<input type="text" id="eventRegInput1" class="form-control border-green" placeholder="Access Token" 
											@if(isset($edit))
							...
							<div class="form-body">
	                			<div class="form-group row last">
	                        		...
	                        		<div class="col-md-7">
										<div class="form-group">
											<input type="text" id="eventRegInput1" class="form-control border-green" placeholder="Application ID" 
											@if(isset($edit))
												value="{{$edit->app_id}}"  
											@endif 
											 name="app_id">
                            ...
                            <div class="form-body">
	                			<div class="form-group row last">
	                        		...
	                        		<div class="col-md-7">
										<div class="form-group">
											<input type="text" id="eventRegInput1" class="form-control border-green" placeholder="Location ID" 
											@if(isset($edit))
							...
							<div class="form-body">
	                			<div class="form-group row last">
	                        		...
	                        		<div class="col-md-7">
										<div class="form-group">
											<input type="checkbox" id="eventRegInput1" class="border-green" placeholder="Module Status" 
											@if(isset($edit))
