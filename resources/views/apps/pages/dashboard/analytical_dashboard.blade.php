                ...
                <div class="row">
                        ...
                        <div class="my-1 text-xs-center">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title text-xs-center">Inventory & Non-Inventory Repair</h5>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 border-right-blue-grey border-right-lighten-5">
                        <div class="my-1  text-xs-center">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title text-xs-center">Sales & Buyback</h5>
                                    <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
...
@section('js')
    ...
    <script>
        ...
        function inventory_non_inventory_repair() {
            var jsonData = $.ajax({
            url: "{{secure_url('analytical/repair/json')}}",
            dataType:"json",
            async: false
            }).responseText;
            var data = google.visualization.arrayToDataTable(jQuery.parseJSON(jsonData));
            var options = {
                title: 'Inventory & Non-Inventory : Repair',
                chartArea: {width: '40%'},
        ...
        function sales_and_buyback() {
            ...
            var jsonData = $.ajax({
            url: "{{secure_url('analytical/salesvsbuyback/json')}}",
            dataType:"json",
            async: false
            }).responseText;
